...
const ApparelUpload = ({ contract, provider }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setOk(true);
      const transaction2 = await signer.addApparelHash(data.productId, hash);
      ...
      <div className="p-4">
        ...
        <form className="space-y-2">
          ...
          <input
            ...
            onChange={(e) =>
              setData({ ...data, tensile_strength: e.target.value })
            }
            className="block w-full h-12 border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            name="tensileTest"
            id="tensileTest"
          ...
          <input
            ...
            onChange={(e) => setData({ ...data, thread_count: e.target.value })}
            type="text"
            className="block w-full h-12 border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            name="bsti"
            id="bsti"
